...
The current stable version is 7.2.16, which is cross-built against Scala 2.10.x, 2.11.x and 2.12.x.
...
You can also find direct download links at the bottom of that page. Choose the file ending in `7.2.16.jar`.
