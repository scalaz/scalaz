...
The current stable version is 7.2.10, which is cross-built against Scala 2.10.x, 2.11.x and 2.12.x.
...
For Maven and other build tools, you can visit [search.maven.org](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.scalaz%22%20AND%20v%3A%227.2.10%22).
...
You can also find direct download links at the bottom of that page. Choose the file ending in `7.2.10.jar`.
