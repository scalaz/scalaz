...
For Maven and other build tools, you can visit [search.maven.org](https://search.maven.org/search?q=g:org.scalaz%20AND%20v:7.3.3).
...
You can also find direct download links at the bottom of that page. Choose the file ending in `7.3.3.jar`.
