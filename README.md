...
The current stable version is 7.3.0, which is cross-built against Scala 2.11.x, 2.12.x, 2.13.x and Scala.js.
...
For Maven and other build tools, you can visit [search.maven.org](https://search.maven.org/search?q=g:org.scalaz%20AND%20v:7.3.0).
...
You can also find direct download links at the bottom of that page. Choose the file ending in `7.3.0.jar`.
