...
object CoyonedaTest extends SpecLite {
  ...
  checkAll(foldable.laws[CoyonedaOption](using implicitly, Coyoneda.coyonedaFoldable))
  ...
  checkAll(foldable1.laws[CoyonedaNel](using implicitly, Coyoneda.coyonedaFoldable1))
