...
sealed trait ToArrowOps0 {
  implicit def ToArrowOpsUnapply[FA](v: FA)(implicit F0: Unapply2[Arrow, FA]): ArrowOps[F0.M, F0.A, F0.B] =
...
trait ToArrowOps extends ToArrowOps0 with ToSplitOps with ToStrongOps with ToCategoryOps {
  ...
  implicit def ToArrowVFromKleisliLike[G[_], F[G[_], _, _], A, B](v: F[G, A, B])(implicit F0: Arrow[F[G, *, *]]): ArrowOps[F[G, *, *], A, B] =
