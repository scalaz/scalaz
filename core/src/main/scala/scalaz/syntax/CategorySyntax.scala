...
sealed trait ToCategoryOps0 {
  implicit def ToCategoryOpsUnapply[FA](v: FA)(implicit F0: Unapply2[Category, FA]): CategoryOps[F0.M, F0.A, F0.B] =
...
trait ToCategoryOps extends ToCategoryOps0 with ToComposeOps {
  ...
  implicit def ToCategoryVFromKleisliLike[G[_], F[G[_], _, _], A, B](v: F[G, A, B])(implicit F0: Category[F[G, *, *]]): CategoryOps[F[G, *, *], A, B] =
