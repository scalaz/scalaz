...
sealed trait ToBitraverseOps0 {
  implicit def ToBitraverseOpsUnapply[FA](v: FA)(implicit F0: Unapply2[Bitraverse, FA]): BitraverseOps[F0.M, F0.A, F0.B] =
...
trait ToBitraverseOps extends ToBitraverseOps0 with ToBifunctorOps with ToBifoldableOps {
  ...
  implicit def ToBitraverseVFromKleisliLike[G[_], F[G[_], _, _], A, B](v: F[G, A, B])(implicit F0: Bitraverse[F[G, *, *]]): BitraverseOps[F[G, *, *], A, B] =
