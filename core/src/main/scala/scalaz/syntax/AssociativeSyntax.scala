...
sealed trait ToAssociativeOps0 {
  implicit def ToAssociativeOpsUnapply[FA](v: FA)(implicit F0: Unapply2[Associative, FA]): AssociativeOps[F0.M, F0.A, F0.B] =
...
trait ToAssociativeOps extends ToAssociativeOps0 {
  ...
  implicit def ToAssociativeVFromKleisliLike[G[_], F[G[_], _, _], A, B](v: F[G, A, B])(implicit F0: Associative[F[G, *, *]]): AssociativeOps[F[G, *, *], A, B] =
