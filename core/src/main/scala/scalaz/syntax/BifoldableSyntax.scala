...
sealed trait ToBifoldableOps0 {
  implicit def ToBifoldableOpsUnapply[FA](v: FA)(implicit F0: Unapply2[Bifoldable, FA]): BifoldableOps[F0.M, F0.A, F0.B] =
...
trait ToBifoldableOps extends ToBifoldableOps0 {
  ...
  implicit def ToBifoldableVFromKleisliLike[G[_], F[G[_], _, _], A, B](v: F[G, A, B])(implicit F0: Bifoldable[F[G, *, *]]): BifoldableOps[F[G, *, *], A, B] =
