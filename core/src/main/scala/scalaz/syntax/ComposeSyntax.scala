...
sealed trait ToComposeOps0 {
  implicit def ToComposeOpsUnapply[FA](v: FA)(implicit F0: Unapply2[Compose, FA]): ComposeOps[F0.M, F0.A, F0.B] =
...
trait ToComposeOps extends ToComposeOps0 {
  ...
  implicit def ToComposeVFromKleisliLike[G[_], F[G[_], _, _], A, B](v: F[G, A, B])(implicit F0: Compose[F[G, *, *]]): ComposeOps[F[G, *, *], A, B] =
