...
sealed trait ToChoiceOps0 {
  implicit def ToChoiceOpsUnapply[FA](v: FA)(implicit F0: Unapply2[Choice, FA]): ChoiceOps[F0.M, F0.A, F0.B] =
...
trait ToChoiceOps extends ToChoiceOps0 with ToCategoryOps {
  ...
  implicit def ToChoiceVFromKleisliLike[G[_], F[G[_], _, _], A, B](v: F[G, A, B])(implicit F0: Choice[F[G, *, *]]): ChoiceOps[F[G, *, *], A, B] =
