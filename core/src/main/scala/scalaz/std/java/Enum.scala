...
object enum extends EnumInstances {
  implicit def enumInstance2[E <: java.lang.Enum[E]](implicit E: ClassManifest[E]): Enum[E] = new Enum[E] {
    private[this] lazy val values: Array[E] = E.erasure.asInstanceOf[Class[E]].getEnumConstants
