...
sealed abstract class ZapInstances {
  ...
  implicit def monadComonadZap[F[_], G[_]](implicit d: Zap[F, G], F: Functor[F], G: Functor[G]): Zap[Free[F, ?], Cofree[G, ?]] =
  ...
  implicit def comonadMonadZap[F[_], G[_]](implicit d: Zap[F, G], F: Functor[F], G: Functor[G]): Zap[Cofree[F, ?], Free[G, ?]] =
