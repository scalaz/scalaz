...
sealed abstract class MaybeInstances {
  ...
  implicit val maybeInstance = new Traverse[Maybe] with MonadPlus[Maybe] with Cozip[Maybe] with Zip[Maybe] with Unzip[Maybe] with IsEmpty[Maybe] with Cobind[Maybe] {
