...
object Leibniz extends Leibnizs
...
trait Leibnizs {
  ...
  def trans[L, H >: L, A >: L <: H, B >: L <: H, C >: L <: H](
    ...
    f.subst[({type λ[α >: L <: H] = Leibniz[L, H, A, α]})#λ](g)

  /**Equality is symmetric */
  def symm[L, H >: L, A >: L <: H, B >: L <: H](
                                                   f: Leibniz[L, H, A, B]
                                                   ): Leibniz[L, H, B, A] =
    f.subst[({type λ[α >: L <: H] = Leibniz[L, H, α, A]})#λ](refl)
  ...
  A >: LA <: HA, A2 >: LA <: HA
    ...
    a.subst[({type λ[α >: LA <: HA] = Leibniz[LT, HT, T[A], T[α]]})#λ](refl)
  ...
  B >: LB <: HB, B2 >: LB <: HB
    ...
    b.subst[({type λ[α >: LB <: HB] = Leibniz[LT, HT, T[A, B], T[A2, α]]})#λ](
      a.subst[({type λ[α >: LA <: HA] = Leibniz[LT, HT, T[A, B], T[α, B]]})#λ](
        refl))
  ...
  C >: LC <: HC, C2 >: LC <: HC
    ...
    c.subst[({type λ[α >: LC <: HC] = Leibniz[LT, HT, T[A, B, C], T[A2, B2, α]]})#λ](
      b.subst[({type λ[α >: LB <: HB] = Leibniz[LT, HT, T[A, B, C], T[A2, α, C]]})#λ](
        a.subst[({type λ[α >: LA <: HA] = Leibniz[LT, HT, T[A, B, C], T[α, B, C]]})#λ](
          refl)))
