...
trait MonadInstances {
  implicit val optionMonad: Monad[Option] = new MonadClass.Template[Option] {
  ...
  implicit val listMonad: Monad[List] = new MonadClass.Template[List] {
  ...
  implicit val functionMonad: Monad[Function0] = new MonadClass.Template[Function0] {
  ...
  implicit def function1Monad[C]: Monad[Function1[C, ?]] = new MonadClass.Template[Function1[C, ?]] {
