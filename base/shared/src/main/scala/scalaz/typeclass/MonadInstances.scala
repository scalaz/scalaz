...
trait MonadInstances {
  ...
  implicit val functionMonad: Monad[Function0] = instanceOf(new MonadClass[Function0] with BindClass.DeriveFlatten[Function0] {
  ...
  implicit def function1Monad[C]: Monad[Function1[C, ?]] = instanceOf(new MonadClass[Function1[C, ?]] with BindClass.DeriveFlatten[Function1[C, ?]] {
