...
trait MonadInstances {
  implicit val optionMonad: Monad[Option] = new Monad.Template[Option] with Bind.DeriveFlatten[Option] {
  ...
  implicit val listMonad: Monad[List] = new Monad.Template[List] with Bind.DeriveFlatten[List] {
  ...
  implicit val functionMonad: Monad[Function0] = new Monad.Template[Function0] with Bind.DeriveFlatten[Function0] {
  ...
  implicit def function1Monad[C]: Monad[Function1[C, ?]] = new Monad.Template[Function1[C, ?]] with Bind.DeriveFlatten[Function1[C, ?]] {
