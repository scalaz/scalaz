...
trait ComonadInstances { instances =>
  implicit def tuple2Cobind[A1]: Comonad[Tuple2[A1, ?]] = new ComonadClass.Cobind[Tuple2[A1, ?]] {
  ...
  implicit val function0Cobind: Comonad[Function0] = new ComonadClass.Cobind[Function0] {
