...
trait ComonadInstances { instances =>
  implicit def tuple2Cobind[A1]: Comonad[Tuple2[A1, ?]] = instanceOf(new ComonadClass[Tuple2[A1, ?]] with CobindClass.DeriveCojoin[Tuple2[A1, ?]]{
  ...
  implicit val function0Cobind: Comonad[Function0] = instanceOf(new ComonadClass[Function0] with CobindClass.DeriveCojoin[Function0] {
