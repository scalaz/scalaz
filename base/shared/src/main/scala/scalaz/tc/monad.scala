...
object MonadClass {
  ...
  implicit val functionMonad: Monad[Function0] = instanceOf(
    new MonadClass[Function0] with BindClass.DeriveFlatten[Function0] {
      override def ap[A, B](fab: Function0[A])(f: Function0[A => B]): Function0[B] =
        () => f()(fab())
      override def map[A, B](fab: Function0[A])(f: A => B): Function0[B] = () => f(fab())
      override def flatMap[A, B](fab: Function0[A])(f: A => Function0[B]): Function0[B] =
        () => f(fab())()
  ...
  implicit def function1Monad[C]: Monad[Function1[C, ?]] =
    instanceOf(new MonadClass[Function1[C, ?]] with BindClass.DeriveFlatten[Function1[C, ?]] {
      override def ap[A, B](fab: Function1[C, A])(f: Function1[C, A => B]): Function1[C, B] =
        (c: C) => f(c)(fab(c))
  ...
  implicit val listMonad: Monad[List] = instanceOf(
    new MonadClass[List] with BindClass.DeriveFlatten[List] {
