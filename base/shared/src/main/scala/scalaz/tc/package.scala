...
package object tc {
  ...
  type BoundedJoinSemiLattice[A] = InstanceOf[BoundedJoinSemiLatticeClass[A]]
  type BoundedLattice[A]         = InstanceOf[BoundedLatticeClass[A]]
  type BoundedMeetSemiLattice[A] = InstanceOf[BoundedMeetSemiLatticeClass[A]]
  ...
  final def BoundedJoinSemiLattice[A](implicit L: BoundedJoinSemiLattice[A]): BoundedJoinSemiLattice[A] = L
  final def BoundedMeetSemiLattice[A](implicit L: BoundedMeetSemiLattice[A]): BoundedMeetSemiLattice[A] = L
  final def BoundedLattice[A](implicit L: BoundedLattice[A]): BoundedLattice[A]                         = L
