...
object Arrow {
  ...
  def CokleisliArrow[W[_]](implicit w: Comonad[W]) = new Arrow[PartialApplyK[Cokleisli, W]#Apply] {
    ...
    def ***[B, C, D, E](a: Cokleisli[W, B, C], b: Cokleisli[W, D, E]): Cokleisli[W, (B, D), (C, E)] =
    // (\ e -> a (((fmap fst) &&& b) (fmap snd e)))
      cokleisli[W]((e: W[(B, D)]) => a((cokleisli[W](&&&(w.fmap(_:W[(C, E)], (_:(C, E))._1), b)).apply(w.fmap(e, (_:(B, D))._2)))))
  }
}
