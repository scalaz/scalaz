...
…/example/src/main/scala/scalaz/example/ContravariantCoyonedaUsage.scala:125: could not find implicit value for parameter B: scalaz.Order[java.io.Serializable]
    ...
    object Binfmt {
      ...
      implicit lazy val descLong: Binfmt[Long] = Binfmt("<Long>")
      implicit lazy val descInt: Binfmt[Int] = Binfmt("<Int>")
      implicit lazy val descString: Binfmt[String] = Binfmt("<String>")
      implicit lazy val descUnit: Binfmt[Unit] = Binfmt("")
